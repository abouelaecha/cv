    ...
    public class CvController {
        ...
        @PostMapping // todo templateid et linkedin
        ...
        // }
        // return new
        // ResponseEntity<>(cvLanguages.stream().map(CvLanguage::getCvLanguagesID).collect(Collectors.toList()),
        // HttpStatus.OK);
        // } catch (ApiException ex) {
        ...
        // public void exportCvToPdf(HttpServletResponse response, @PathVariable Long
        // cvId) {
        // try {
        // byte[] data = cvService.exportCvToPdf(cvId);
        // response.setContentType("application/pdf");
        // response.setHeader("Content-Disposition", "inline; filename=cv_" + cvId +
        // ".pdf");
